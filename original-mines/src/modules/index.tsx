...
import MinesBoard from 'components/games/mines-board'
import { MinesStateProvider } from 'components/games/mines-context'
import SidebarMines from 'components/games/mines-sidebar'
  ...
  return (
    ...
    <MinesStateProvider>
      <Wrapper ref={ref} $mobile={dimensions.width <= 750}>
        ...
        <SidebarMines changeLayout={false} />
      </Wrapper>
    </MinesStateProvider>
  )
}
